...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    void Update()
    {
        ...
        if(MethodExtend.readFromButton == 1 && activo2 == false)
        {
            ...
            // paintWordPosition(1500, 200, "HELLO THIS IS A SENTENCE");
        }
        ...
        if(ScriptCommunication.wordToPaintThree == true && ScriptCommunication.activateWordToPaint == true)
        {
             
            set_bool = !set_bool;
            ScriptCommunication.wordToPaintThree = false;
        ...
        if(ScriptCommunication.wordToPaintSix == true && ScriptCommunication.activateWordToPaint == true)
        {

            ScriptCommunication.wordToPaintSix = false;
            ScriptCommunication.activateWordToPaint = false;   
        ...
        if(activateWordInput == true && activateLenghtVerification == true)
        {
            ...
            Debug.Log( "comunication     " + ScriptCommunication.StringTextField + "     "  + tuplaWords[positionLeftOrRight]);
            ...
            if(ScriptCommunication.StringTextField == tuplaWords[positionLeftOrRight])
            {
                ...
                if(lengthThreeOrSix == 3)
                {
                    ...
                    // Vector3 variableLearn = particle_twinkle.transform.position;
        
                    particle_twinkle.transform.position = new Vector3(-6f, 0.9f, particle_twinkle.transform.position.z);
                    ...
                    if(positionLeftOrRight == 0) 
                    {
                        ...
                        particle_twinkle.transform.position = new Vector3(-6f, 0.9f - 0.9f * countPositionOfEraseWordLeft, particle_twinkle.transform.position.z);

                        particle_twinkle.Play(true);
                ...
                // 1
                    ...
                    else
                    {
                        ...
                        particle_twinkle.transform.position = new Vector3(0.5f, 0.9f - 0.9f  * countPositionOfEraseWordRight, particle_twinkle.transform.position.z);
                ...
                else
                {
                    ...
                    particle_twinkle.transform.position = new Vector3(-6f, 2.25f, particle_twinkle.transform.position.z);
                    ...
                    if(positionLeftOrRight == 0) 
                    {
                        ...
                        particle_twinkle.transform.position = new Vector3(-6f, 2.25f - 0.8999999999f * countPositionOfEraseWordRight, particle_twinkle.transform.position.z);
                    ...
                    else
                    {
                        ...
                        particle_twinkle.transform.position = new Vector3(1f, 2.25f - 0.8999999999f * countPositionOfEraseWordRight, particle_twinkle.transform.position.z);
